...
// 2020-04-03T21:07:43+02:00 => ['2020-04-03', '19:07']\docs\ckeditor5\latest\index.html
...
export default {
  ...
  methods: {
    renderDateProp(h) {
      if (this.fullSchema.type !== 'string' || !['date', 'date-time', 'time', 'geoloc'].includes(this.fullSchema.format)) return

      let child
      let prependIcon = this.fullOptions.icons.calendar
      if (this.fullSchema.format === 'time') {
        child = h('scout-time-picker', {
          props: {
      ...
      } else if (this.fullSchema.format === 'date-time') {
        child = h('scout-datetime-picker', {
          props: {
            // ...this.fullOptions.datePickerProps,
            value: this.value,
          },
        ...
        //   h('v-tab-item', { props: { value: 'tab-date' } }, [h('scout-date-picker', {//-------------------
        //     props: {
        //       ...this.fullOptions.datePickerProps,
        //       // locale: this.fullOptions.locale, //----------------
        //       'no-title': false,
        ...
        //     }
        //   })]),
        //   h('v-tab-item', { props: { value: 'tab-time' } }, [h('scout-time-picker', {  //-------------------
        //     props: {
        //       ...this.fullOptions.timePickerProps,
        //       // locale: this.fullOptions.locale, //-------------------
        ...
        child = h('scout-geoloc-picker', {
          props: {
            dialog: this.dialog,
          },
          on: {
            input: value => { this.input(value), this.dialog = !this.dialog},
            change: value => this.change(value),
