export const getRules = (fullSchema, options, required, isOneOfSelect) => {
  ...
  if (fullSchema.serverMessage !== undefined && fullSchema.serverMessage !== null) {
    const msg = options.messages.serverMessage.replace('{serverMessage}', fullSchema.serverMessage)
    rules.push(msg)
  }
